...
const steps = [
  {
    ...
    text: "Проходишь тест силы самостоятельно по инструкции или в зале с тренером: 5–7 упражнений в зависимости от выбранного курса. Фиксируем текущий уровень и выбираем главную цель.",
  ...
  },
  {
    ...
    text: "Выполняешь тренировки по приложению. Онлайн — отправляешь видео-отчёты тренеру и получаешь детальную обратную связь. В зале — тренируешься в группе, тренер подсказывает технику и мотивирует. В любом формате видишь прогресс и становишься ближе к своей цели.",
...
export function HowItWorks() {
  return (
    <section
      id="how"
      className="relative w-full border-t border-white/5 bg-[#050816] scroll-mt-[calc(var(--header-h)+var(--anchor-extra))]"
    >
